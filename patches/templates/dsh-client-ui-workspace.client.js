window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/xipian/workspace/wbs/deepseek-harness-desktop/deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".ozLDBG_projectRow,.ozLDBG_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.ozLDBG_projectRow:hover,.ozLDBG_sessionRow:hover,.ozLDBG_sessionRow.ozLDBG_selected{background:var(--dsw-alias-interactive-bg-hover)}.ozLDBG_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.ozLDBG_searchResultRow:hover,.ozLDBG_searchResultRow.ozLDBG_selected{background:var(--dsw-alias-interactive-bg-hover)}.ozLDBG_searchResultHeading{align-items:center;min-width:0;display:flex}.ozLDBG_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.ozLDBG_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.ozLDBG_searchResultWorkspace,.ozLDBG_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.ozLDBG_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.ozLDBG_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.ozLDBG_projectRow{box-sizing:border-box;align-items:center;height:34px}.ozLDBG_projectRow .ozLDBG_rowActions{height:20px}.ozLDBG_sessionRow{height:32px;animation:ozLDBG_row-in .15s var(--ds-ease-in-out);gap:0}.ozLDBG_sessionRow .ozLDBG_title{margin:0 6px 0 4px}.ozLDBG_flatSessionRowWithoutStatus .ozLDBG_title{margin-left:0}@keyframes ozLDBG_row-in{0%{opacity:0}}.ozLDBG_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.ozLDBG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.ozLDBG_folderActive{color:var(--dsw-alias-state-business-primary)}.ozLDBG_projectRow .ozLDBG_chevron{display:none}.ozLDBG_projectRow:hover .ozLDBG_chevron{display:inline-flex}.ozLDBG_projectRow:hover .ozLDBG_folder{display:none}.ozLDBG_arrow{transition:transform .15s var(--ds-ease-in-out)}.ozLDBG_arrowOpen{transform:rotate(90deg)}.ozLDBG_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.ozLDBG_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.ozLDBG_renameInput{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.ozLDBG_sessionRow .ozLDBG_title{flex:1}.ozLDBG_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.ozLDBG_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.ozLDBG_scheduleIndicator{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex}.ozLDBG_searchScheduleIndicator{margin-left:4px;margin-right:0}.ozLDBG_dot{flex:none}.ozLDBG_rowActions{flex:none;align-items:center;gap:12px;display:none}.ozLDBG_projectRow:hover .ozLDBG_rowActions,.ozLDBG_sessionRow:hover .ozLDBG_rowActions,.ozLDBG_projectRow.ozLDBG_menuOpen .ozLDBG_rowActions,.ozLDBG_sessionRow.ozLDBG_menuOpen .ozLDBG_rowActions{display:inline-flex}.ozLDBG_sessionRow:hover .ozLDBG_time,.ozLDBG_sessionRow.ozLDBG_menuOpen .ozLDBG_time{display:none}.ozLDBG_projectRow.ozLDBG_menuOpen,.ozLDBG_sessionRow.ozLDBG_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.ozLDBG_sessionRow.ozLDBG_dropBefore,.ozLDBG_sessionRow.ozLDBG_dropAfter{position:relative}.ozLDBG_sessionRow.ozLDBG_dropBefore:before,.ozLDBG_sessionRow.ozLDBG_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.ozLDBG_sessionRow.ozLDBG_dropBefore:before{top:-7px}.ozLDBG_sessionRow.ozLDBG_dropAfter:after{bottom:-7px}.ozLDBG_hoverContent{flex-direction:column;gap:8px;display:flex}.ozLDBG_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.ozLDBG_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.ozLDBG_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.ozLDBG_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.ozLDBG_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ozLDBG_iconButton:hover{color:var(--dsw-alias-label-primary)}.ozLDBG_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.ozLDBG_sessionRow,.ozLDBG_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "ozLDBG_arrow",
			"arrowOpen": "ozLDBG_arrowOpen",
			"chevron": "ozLDBG_chevron",
			"dot": "ozLDBG_dot",
			"dropAfter": "ozLDBG_dropAfter",
			"dropBefore": "ozLDBG_dropBefore",
			"flatSessionRowWithoutStatus": "ozLDBG_flatSessionRowWithoutStatus",
			"folder": "ozLDBG_folder",
			"folderActive": "ozLDBG_folderActive",
			"hoverContent": "ozLDBG_hoverContent",
			"hoverPath": "ozLDBG_hoverPath",
			"hoverStatus": "ozLDBG_hoverStatus",
			"hoverTime": "ozLDBG_hoverTime",
			"hoverTitle": "ozLDBG_hoverTitle",
			"iconButton": "ozLDBG_iconButton",
			"menuOpen": "ozLDBG_menuOpen",
			"meta": "ozLDBG_meta",
			"projectRow": "ozLDBG_projectRow",
			"projectText": "ozLDBG_projectText",
			"renameInput": "ozLDBG_renameInput",
			"row-in": "ozLDBG_row-in",
			"rowActions": "ozLDBG_rowActions",
			"scheduleIndicator": "ozLDBG_scheduleIndicator",
			"searchResultHeading": "ozLDBG_searchResultHeading",
			"searchResultMeta": "ozLDBG_searchResultMeta",
			"searchResultRow": "ozLDBG_searchResultRow",
			"searchResultSnippet": "ozLDBG_searchResultSnippet",
			"searchResultTitle": "ozLDBG_searchResultTitle",
			"searchResultWorkspace": "ozLDBG_searchResultWorkspace",
			"searchScheduleIndicator": "ozLDBG_searchScheduleIndicator",
			"selected": "ozLDBG_selected",
			"sessionRow": "ozLDBG_sessionRow",
			"slot": "ozLDBG_slot",
			"time": "ozLDBG_time",
			"title": "ozLDBG_title",
			"visuallyHidden": "ozLDBG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		/** Drag contract shared with the conversation composer: the composer's drop
		* consumes this payload as a copy reference, never a reorder. */
		...
		function sessionReferenceMention(sessionId, label) {
			...
			return `@[${escapedLabel}](dsh-session:${payload})`;
		}
		...
		*/
		function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, drag, flat = false, t }) {
			...
			return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
				anchor: (0, react_jsx_runtime.jsxs)("div", {
					...
					draggable: drag !== void 0,
					onDragStart: drag === void 0 ? void 0 : (e) => {
						const mention = sessionReferenceMention(node.id, title);
						e.dataTransfer.effectAllowed = "copyMove";
						e.dataTransfer.setData(SESSION_REFERENCE_MIME, JSON.stringify({
							version: 1,
							sessionId: node.id,
							label: title,
							mention
		...
		//#endregion
		//#region \0dsh-css:/Users/xipian/workspace/wbs/deepseek-harness-desktop/deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".oYNJQa_modalAction{min-width:72px}.oYNJQa_modalError,.oYNJQa_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.oYNJQa_modalError{color:var(--dsw-alias-state-error-primary)}.oYNJQa_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "oYNJQa_menuStatus",
			"modalAction": "oYNJQa_modalAction",
			"modalError": "oYNJQa_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/xipian/workspace/wbs/deepseek-harness-desktop/deepseek-harness/packages/client/ui-workspace/src/client/rows/WorkspaceBrowser.module.css.mjs
		const css = ".SJMXQW_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.SJMXQW_root.SJMXQW_rail{padding-right:0}.SJMXQW_iconButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.SJMXQW_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.SJMXQW_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.SJMXQW_root:not(.SJMXQW_rail) .SJMXQW_sectionHeader{margin-top:2px;margin-right:-4px}.SJMXQW_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.SJMXQW_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.SJMXQW_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.SJMXQW_searchSlotExpanded{max-width:100%;padding-left:0}.SJMXQW_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.SJMXQW_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.SJMXQW_search{box-sizing:border-box;corner-shape:round;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.SJMXQW_searchExpanded{border:.5px solid var(--dsw-alias-border-l4);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.SJMXQW_searchButton{corner-shape:round;cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.SJMXQW_searchExpanded .SJMXQW_searchButton{width:28px;height:30px}.SJMXQW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.SJMXQW_searchExpanded .SJMXQW_searchButton:hover{background:0 0}.SJMXQW_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.SJMXQW_searchExpanded .SJMXQW_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.SJMXQW_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.SJMXQW_clearButton{corner-shape:round;cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.SJMXQW_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.SJMXQW_rail .SJMXQW_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.SJMXQW_rail .SJMXQW_headerActions{max-width:none}.SJMXQW_rail .SJMXQW_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.SJMXQW_rail .SJMXQW_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.SJMXQW_rail .SJMXQW_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.SJMXQW_rail .SJMXQW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.SJMXQW_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.SJMXQW_rail .SJMXQW_listArea{margin-left:0;margin-right:0;padding-left:0}.SJMXQW_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.SJMXQW_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.SJMXQW_wide{animation:SJMXQW_wide-in .2s var(--ds-ease-in-out)}@keyframes SJMXQW_wide-in{0%{opacity:0}}.SJMXQW_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.SJMXQW_flatList>*+*,.SJMXQW_searchTree>[role=treeitem]+[role=treeitem],.SJMXQW_groupSection>*+*{margin-top:2px}.SJMXQW_searchStatus,.SJMXQW_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.SJMXQW_searchWarning{color:var(--dsw-alias-label-secondary)}.SJMXQW_groupSection{position:relative}.SJMXQW_groupSection+.SJMXQW_groupSection{margin-top:4px}.SJMXQW_listTopDropIndicator,.SJMXQW_workspaceDropBefore:before,.SJMXQW_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.SJMXQW_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.SJMXQW_listTopDropActive>.SJMXQW_workspaceDropBefore:first-child:before{display:none}.SJMXQW_workspaceDropBefore:before{top:-8px}.SJMXQW_workspaceDropAfter:after{bottom:-8px}.SJMXQW_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.SJMXQW_groupSection>.SJMXQW_sessionOverflowButton{margin-top:0}.SJMXQW_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.SJMXQW_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.SJMXQW_renameInput{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.SJMXQW_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.SJMXQW_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.SJMXQW_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.SJMXQW_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.SJMXQW_wide{animation:none}.SJMXQW_search,.SJMXQW_sectionLabel,.SJMXQW_searchSlot,.SJMXQW_searchInput,.SJMXQW_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "SJMXQW_clearButton",
			"deleteAction": "SJMXQW_deleteAction",
			"deleteStatus": "SJMXQW_deleteStatus",
			"empty": "SJMXQW_empty",
			"fade": "SJMXQW_fade",
			"flatList": "SJMXQW_flatList",
			"groupSection": "SJMXQW_groupSection",
			"headerActions": "SJMXQW_headerActions",
			"headerActionsHidden": "SJMXQW_headerActionsHidden",
			"iconButton": "SJMXQW_iconButton",
			"list": "SJMXQW_list",
			"listArea": "SJMXQW_listArea",
			"listTopDropActive": "SJMXQW_listTopDropActive",
			"listTopDropIndicator": "SJMXQW_listTopDropIndicator",
			"rail": "SJMXQW_rail",
			"renameError": "SJMXQW_renameError",
			"renameInput": "SJMXQW_renameInput",
			"root": "SJMXQW_root",
			"search": "SJMXQW_search",
			"searchButton": "SJMXQW_searchButton",
			"searchExpanded": "SJMXQW_searchExpanded",
			"searchInput": "SJMXQW_searchInput",
			"searchSlot": "SJMXQW_searchSlot",
			"searchSlotExpanded": "SJMXQW_searchSlotExpanded",
			"searchStatus": "SJMXQW_searchStatus",
			"searchTree": "SJMXQW_searchTree",
			"searchWarning": "SJMXQW_searchWarning",
			"sectionHeader": "SJMXQW_sectionHeader",
			"sectionLabel": "SJMXQW_sectionLabel",
			"sectionLabelHidden": "SJMXQW_sectionLabelHidden",
			"sessionOverflowButton": "SJMXQW_sessionOverflowButton",
			"treeBody": "SJMXQW_treeBody",
			"wide": "SJMXQW_wide",
			"wide-in": "SJMXQW_wide-in",
			"workspaceDropAfter": "SJMXQW_workspaceDropAfter",
			"workspaceDropBefore": "SJMXQW_workspaceDropBefore"
		};
		//#endregion
										...
										return (0, react_jsx_runtime.jsx)(SessionNodeItem, {
											...
											drag: {
												...
												drop: (half) => {
													...
													if (dropEffect === "copy") setDrag(null);
													else if (drag?.over !== null && drag?.over !== void 0) commitSessionDrag(drag, drag.over);
													else setDrag(null);
													sessionDropCommitted.current = false;
												}
											},
						...
						return (0, react_jsx_runtime.jsx)(SessionNodeItem, {
							...
							drag: {
								...
								drop: (half) => {
									...
									if (dropEffect === "copy") setDrag(null);
									else if (drag?.over !== null && drag?.over !== void 0) commitDrag(drag, drag.over);
									else setDrag(null);
									dropCommitted.current = false;
								}
							},
